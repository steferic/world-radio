...
// the panel; a rectangle that is fully off-screen is essentially a no-op.
void lcd_fill_rect(int x, int y, int w, int h, uint16_t color);

// Transmits a caller-supplied RGB565 pixel buffer (w*h pixels, row-major,
...
// partly off-screen is almost always a layout bug worth recording.
