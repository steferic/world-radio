...
// schreibfaul1's Audio lib hands us "Artist - Title" as one string when
// the stream provides it that way; split on the first " - " so callers
// can show them separately. Falls back to putting the whole string in
// the title if there's no separator.
